...
elseif nbf == 1
    if nwf == 1
        ...
        for ii = 1:3:length(ranovatbl.SumSq)
            eta2G{ii,1} = ranovatbl.SumSq(ii)/(ranovatbl.SumSq(3)+ranovatbl.SumSq(ii)+ranovatbl.SumSq(end));
            eta2G{ii+1,1} = ranovatbl.SumSq(ii+1)/(ranovatbl.SumSq(3)+ranovatbl.SumSq(ii+1)+ranovatbl.SumSq(end));
        end
    end
else
end
